...
levelRange:
  ...
  max: 20
parts: 6
tags: ["Undead", "Geb", "Epic", "Evil Campaign", "Politics", "Dark Fantasy"]
publisher: "Paizo"
...
- **Undead Nation**: Explore Geb where undead rule
- **Full 1-20 Campaign**: Complete epic progression
- **Moral Complexity**: Navigate a society where undeath is normal
- **Political Ascension**: Rise to join the ruling Blood Lords
- **Necromantic Themes**: Undeath, necromancy, and dark magic
- **Unique Perspective**: Experience an "evil" nation from inside
- **Social Challenges**: Balance ethics in morally gray situations
...
The adventure unfolds across six books:

1. **Part 1** (Levels 1-3) - Troubleshooters for the undead elite
2. **Part 2** (Levels 4-6) - Deeper into Geb's politics
3. **Part 3** (Levels 7-10) - Rising influence and dark secrets
4. **Part 4** (Levels 11-14) - Major players in undead society
5. **Part 5** (Levels 15-17) - Approaching the Blood Lords
6. **Part 6** (Levels 18-20) - Join the ruling council

## What Makes This Campaign Special

- Unique setting in undead-ruled nation
- Morally complex narrative in gray territory
- Full 1-20 adventure path
- Explores necromancy and undeath thoughtfully
- Political intrigue and social climbing
- Rare opportunity to work with undead society
- Character progression mirrors political ascension
- Deep exploration of Geb and its culture
