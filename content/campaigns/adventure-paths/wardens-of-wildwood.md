...
levelRange:
  ...
  max: 13
parts: 6
tags: ["Nature", "Druids", "Forest", "Environmental", "Fey", "Wilderness"]
publisher: "Paizo"
...
1. **Part 1** (Levels 5-6) - Introduction to the Wildwood and treaty ceremonies
2. **Part 2** (Levels 6-7) - First major threats emerge
3. **Part 3** (Levels 8-9) - Deeper into fey politics and forest secrets
4. **Part 4** (Levels 9-10) - Escalating conflicts
5. **Part 5** (Levels 11-12) - Crisis point for the Wildwood
6. **Part 6** (Levels 12-13) - Final defense and resolution
