        ...
        <Container key={title} className="group/section [counter-increment:section]">
            <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
                ...
                <div className="mt-12 lg:mt-0 lg:w-[37rem] lg:flex-none lg:group-even/section:order-first">
                    <FadeIn>
                        <div
                            className="font-display text-base font-semibold before:text-neutral-300 dark:before:text-gray-500 before:content-['/_'] after:text-neutral-950 dark:after:text-white after:content-[counter(section,decimal-leading-zero)]"
                            aria-hidden="true"
                        />
                        <h2 className="mt-2 font-display text-3xl font-medium tracking-tight text-neutral-950 dark:text-white sm:text-4xl">
                            {title}
                        </h2>
                        <div className="mt-6">
                            <div className="space-y-6 text-base text-neutral-600 dark:text-neutral-50">
                                <p>
                                    {description}
                                </p>
                            </div>
