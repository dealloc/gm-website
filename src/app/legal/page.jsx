    ...
    return (
        <Container className="flex h-full items-center pt-24 sm:pt-32 lg:pt-40">
            <FadeIn className="flex max-w-xl flex-col items-center text-center">
                ...
                <Divider />
                <h1 className="mt-6 font-display text-2xl font-semibold text-neutral-950">
                    Data Collection
                </h1>
                <p className="mt-2 text-sm text-neutral-600">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                    ...
                    <a href="https://www.elixus.be" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
                        elixus.be
                    </a>
                </p>
            </FadeIn>
